...
else if(response.status === "You don't have permission to access this patient's profile OR this patient with given ID does not exist")
{
    alert(`Either Patient with Patient Id: ${response.patient_id} does not exist or You don't have right to view and alter their profile !!!! `);
}
...
else if(response.status === "Doctor token is not valid")
{
